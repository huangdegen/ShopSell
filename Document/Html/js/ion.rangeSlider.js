        ...
        appendGrid: function () {
            ...
            for (i = 0; i < big_num + 1; i++) {
                ...
                for (z = 1; z <= local_small_max; z++) {
                    ...
                    //html += '<span class="irs-grid-pol small" style="left: ' + small_w + '%"></span>'; //加载标尺小刻度
                }
                if(o.b_values[i] === ""){
                    html += '<span class="irs-grid-pol" style="left: ' + big_w + '%"></span>';
                } else{
                    html += '<span class="irs-grid-pol irs-grid-pol-blank" style="left: ' + big_w + '%"></span>';
                }
                
                result = this.calcReal(big_w);
                if (o.b_values.length) {
                    result = o.b_values[result];
                } else {
