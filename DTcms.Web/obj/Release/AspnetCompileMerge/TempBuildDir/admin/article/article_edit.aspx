...
<div id="floatHead" class="content-tab-wrap">
  <div class="content-tab">
    <div class="content-tab-ul-wrap">
      <ul>
        <li><a class="selected" href="javascript:;">高级选项</a></li>
...
<div class="tab-content special-tab">
  ...
  <dl>
    ...
    <dd>
      <div class="rule-single-select">
        <asp:DropDownList id="ddlShopStyle" runat="server" datatype="*" sucmsg=" "></asp:DropDownList>
      </div>
    </dd>
  </dl>
   <dl>
    ...
    <dd>
      <div class="rule-single-select">
        <asp:DropDownList id="ddlRegiserStyle" runat="server" datatype="*" sucmsg=" "></asp:DropDownList>
      </div>
    </dd>
  </dl>
  <dl>
    ...
    <dd>
      <div class="rule-single-select">
        <asp:DropDownList id="ddlChopStyle" runat="server" datatype="*" sucmsg=" "></asp:DropDownList>
      </div>
    </dd>
  </dl>
  <dl>
    ...
    <dd>
      <div class="rule-single-select">
        <asp:DropDownList id="ddlTradeStyle" runat="server" datatype="*" sucmsg=" "></asp:DropDownList>
      </div>
    </dd>
  </dl>
  <dl>
    ...
    <dd>
      <div class="rule-single-select">
        <asp:DropDownList id="ddlPriceStyle" runat="server" datatype="*" sucmsg=" "></asp:DropDownList>
      </div>
    </dd>
  </dl>
   <dl>
    ...
    <dd>
      <div class="rule-single-select">
        <asp:DropDownList id="ddlArea" runat="server" datatype="*" sucmsg=" "></asp:DropDownList>
      </div>
    </dd>
  </dl>
  <dl>
    ...
    <dd>
      <div class="rule-single-select">
        <asp:DropDownList id="ddlDeductPoint" runat="server" datatype="*" sucmsg=" "></asp:DropDownList>
      </div>
    </dd>
  </dl>
  <dl>
    ...
    <dd>
      <div class="rule-single-select">
        <asp:DropDownList id="ddlAptitude" runat="server" datatype="*" sucmsg=" "></asp:DropDownList>
      </div>
    </dd>
  </dl>
  <dl>
    ...
    <dd>
      <div class="rule-single-select">
        <asp:DropDownList id="ddlTakeGoods" runat="server" datatype="*" sucmsg=" "></asp:DropDownList>
      </div>
    </dd>
  </dl>
  <dl>
    ...
    <dd>
      <div class="rule-single-select">
        <asp:DropDownList id="ddlSupplyGoods" runat="server" datatype="*" sucmsg=" "></asp:DropDownList>
      </div>
    </dd>
  </dl>
  <dl>
    ...
    <dd>
      <div class="rule-single-select">
        <asp:DropDownList id="ddlChopType" runat="server" datatype="*" sucmsg=" "></asp:DropDownList>
      </div>
    </dd>
  </dl>
  <dl>
    ...
    <dd>
      <div class="rule-single-select">
        <asp:DropDownList id="ddlChopTransfer" runat="server" datatype="*" sucmsg=" "></asp:DropDownList>
      </div>
    </dd>
  </dl>
  <dl>
    ...
    <dd>
      <div class="rule-single-select">
        <asp:DropDownList id="ddlTeamTransfer" runat="server" datatype="*" sucmsg=" "></asp:DropDownList>
      </div>
    </dd>
  </dl>
    <dl>
    ...
    <dd>
      <div class="rule-single-select">
        <asp:DropDownList id="ddlExperience" runat="server" datatype="*" sucmsg=" "></asp:DropDownList>
      </div>
    </dd>
  </dl>
</div>
